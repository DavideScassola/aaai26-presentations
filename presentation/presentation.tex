...
\begin{frame}[fragile]{Why is generating relational data hard?}
  ...
  \begin{itemize}
    ...
    %\item Difficulties of tabular data generation: heterogeneous data types, complex marginals and dependencies
  \end{itemize}
...
\begin{frame}[fragile]{Relational Data as a Graph}
  ...
  \begin{itemize}
    \item The foreign key graph can be complex.
...
from the original graph)
  ...
  \begin{equation*}
v_t^\theta(X_t) = \mathbb{E}_{\mathbf{X}_1 \sim \textcolor{red}{p_\theta(X_1 \mid  X_t, G)}} \left[ \textcolor{blue}{u_t(X_t \mid X_1)} \right]  \end{equation*}
\end{enumerate}
